...
/* Standard interface: IWGServiceManager, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO IWGServiceManager_ProxyInfo;


static const RPC_CLIENT_INTERFACE IWGServiceManager___RpcClientInterface =
    {
    ...
    0,
    0,
    &IWGServiceManager_ProxyInfo,
    0x02000000
    };
RPC_IF_HANDLE IWGServiceManager_v1_0_c_ifspec = (RPC_IF_HANDLE)& IWGServiceManager___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE IWGServiceManager__MIDL_AutoBindHandle;


long IWGSM_GetState( 
    /* [in] */ handle_t IDL_handle,
    /* [out] */ boolean *bIsConnected)
{

    CLIENT_CALL_RETURN _RetVal;

    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&IWGServiceManager_ProxyInfo,
                  0,
                  0,
                  IDL_handle,
                  bIsConnected);
...
static const MIDL_STUB_DESC IWGServiceManager_StubDesc = 
    {
    (void *)& IWGServiceManager___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IWGServiceManager__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& IWGServiceManager_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO IWGServiceManager_ProxyInfo =
    {
